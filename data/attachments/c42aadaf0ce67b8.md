...
- Name: my-credentials/C22670975-verify-saved-views-options-are-available-on-my-credentials-page.spec.ts >> My Credentials >> @regression C22670975: Verify saved views options are available on My Credentials page
- Location: src/tests/my-credentials/C22670975-verify-saved-views-options-are-available-on-my-credentials-page.spec.ts:18:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e6]: 2026-09-15 05:46:44
```
