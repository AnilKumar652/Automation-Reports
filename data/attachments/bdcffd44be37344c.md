...
- Name: apparatus/C22779515-verify-apparatus-can-be-created-successfully-with-required-fields.spec.ts >> Apparatus >> @smoke @regression C22779515: Verify apparatus can be created successfully with required fields
- Location: src/tests/apparatus/C22779515-verify-apparatus-can-be-created-successfully-with-required-fields.spec.ts:40:7
...
Call log:
  - waiting for locator('role=cell[name="Crawford County Team"i]') to be visible
