...
- Name: my-credentials/C22670980-verify-pagination-and-page-size-controls-display-on-my-credentials-grid.spec.ts >> My Credentials >> @regression C22670980: Verify pagination and page size controls display on My Credentials grid
- Location: src/tests/my-credentials/C22670980-verify-pagination-and-page-size-controls-display-on-my-credentials-grid.spec.ts:17:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e6]: 2026-09-15 05:50:38
```
