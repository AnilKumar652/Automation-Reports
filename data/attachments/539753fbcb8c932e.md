...
- Name: credentials/C52162-verify-credential-status-in-personnel-matches-training-credentials.spec.ts >> Credentials — Personnel >> @regression C52162: Verify credential status in Personnel matches Training Credentials
- Location: src/tests/credentials/C52162-verify-credential-status-in-personnel-matches-training-credentials.spec.ts:19:7
