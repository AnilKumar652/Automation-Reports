...
- Name: my-credentials/C22682821-verify-my-credentials-grid-columns-can-be-sorted.spec.ts >> My Credentials >> @regression C22682821: Verify My Credentials grid columns can be sorted
- Location: src/tests/my-credentials/C22682821-verify-my-credentials-grid-columns-can-be-sorted.spec.ts:16:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e6]: 2026-09-05 05:43:42
```
