...
- Name: my-credentials/C22670973-verify-filter-panel-applies-filters-on-my-credentials-grid.spec.ts >> My Credentials >> @regression C22670973: Verify filter panel applies filters on My Credentials grid
- Location: src/tests/my-credentials/C22670973-verify-filter-panel-applies-filters-on-my-credentials-grid.spec.ts:21:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e6]: 2026-09-26 05:55:17
```
