...
- Name: my-credentials/C22670981-verify-empty-state-displays-when-no-credentials-match-selected-status-tab.spec.ts >> My Credentials >> @regression C22670981: Verify empty state displays when no credentials match selected status tab
- Location: src/tests/my-credentials/C22670981-verify-empty-state-displays-when-no-credentials-match-selected-status-tab.spec.ts:19:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e6]: 2026-09-15 05:52:37
```
