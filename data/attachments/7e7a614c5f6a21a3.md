...
- Name: my-credentials/C22670979-verify-download-csv-option-is-available-on-my-credentials-grid.spec.ts >> My Credentials >> @regression C22670979: Verify Download CSV option is available on My Credentials grid
- Location: src/tests/my-credentials/C22670979-verify-download-csv-option-is-available-on-my-credentials-grid.spec.ts:16:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e6]: 2026-09-05 05:37:46
```
