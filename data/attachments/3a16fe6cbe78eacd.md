...
- Name: my-credentials/C22682820-verify-search-with-no-matching-credentials-displays-empty-state.spec.ts >> My Credentials >> @regression C22682820: Verify search with no matching credentials displays empty state
- Location: src/tests/my-credentials/C22682820-verify-search-with-no-matching-credentials-displays-empty-state.spec.ts:21:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e6]: 2026-09-19 05:38:33
```
