...
- Name: my-credentials/C22682823-verify-progress-column-displays-completion-percentage-for-credentials-with-requirements.spec.ts >> My Credentials >> @regression C22682823: Verify Progress column displays completion percentage for credentials with requirements
- Location: src/tests/my-credentials/C22682823-verify-progress-column-displays-completion-percentage-for-credentials-with-requirements.spec.ts:16:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e6]: 2026-09-05 05:46:04
```
