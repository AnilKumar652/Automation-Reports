...
- Name: credentials/C7283439-verify-autogenerate-toggle-for-credential-id-during-credential-creation.spec.ts >> Credentials >> @smoke @regression C7283439: Verify autogenerate toggle for credential ID during credential creation
- Location: src/tests/credentials/C7283439-verify-autogenerate-toggle-for-credential-id-during-credential-creation.spec.ts:22:7
...
Call log:
  - waiting for getByRole('link', { name: 'Autogenerate' }) to be visible
