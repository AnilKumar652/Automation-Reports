...
- Name: my-credentials/C22670977-verify-upload-external-credential-modal-opens-with-required-fields.spec.ts >> My Credentials - Upload External Credential >> @smoke @regression C22670977: Verify Upload External Credential modal opens with required fields
- Location: src/tests/my-credentials/C22670977-verify-upload-external-credential-modal-opens-with-required-fields.spec.ts:17:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e6]: 2026-09-26 06:00:00
```
