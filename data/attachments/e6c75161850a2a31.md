...
- Name: my-credentials/C22670971-verify-my-credentials-grid-displays-all-expected-columns.spec.ts >> My Credentials >> @smoke @regression C22670971: Verify My Credentials grid displays all expected columns
- Location: src/tests/my-credentials/C22670971-verify-my-credentials-grid-displays-all-expected-columns.spec.ts:17:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e6]: 2026-09-05 05:29:27
```
