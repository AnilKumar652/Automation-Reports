...
- Name: my-credentials/C22670976-verify-view-row-action-opens-credential-details-page.spec.ts >> My Credentials >> @smoke @regression C22670976: Verify View row action opens credential details page
- Location: src/tests/my-credentials/C22670976-verify-view-row-action-opens-credential-details-page.spec.ts:19:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e6]: 2026-09-26 06:00:51
```
