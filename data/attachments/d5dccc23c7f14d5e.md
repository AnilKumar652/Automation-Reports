...
- Name: my-credentials/C22670978-validate-required-field-errors-display-on-upload-external-credential-submission.spec.ts >> My Credentials - Upload External Credential >> @regression C22670978: Validate required field errors display on Upload External Credential submission
- Location: src/tests/my-credentials/C22670978-validate-required-field-errors-display-on-upload-external-credential-submission.spec.ts:19:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e6]: 2026-09-26 06:02:02
```
