...
- Name: my-credentials/C22670974-verify-column-visibility-can-be-managed-on-my-credentials-grid.spec.ts >> My Credentials >> @regression C22670974: Verify column visibility can be managed on My Credentials grid
- Location: src/tests/my-credentials/C22670974-verify-column-visibility-can-be-managed-on-my-credentials-grid.spec.ts:18:7
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e6]: 2026-09-05 05:33:58
```
